...
//            binding.modelSwitcher.setBackgroundResource(R.drawable.bg_rounded_dropdown)
    ...
    override fun onDestroy() {
        ...
        // Headless-inference-box behavior: leaving the chat UI must NOT stop
        // the API service. The service is owned by the Service Console now;
        // official code stopped it here, which made the console flip to
        // "stopped" whenever the user peeked at the chat screen.
    }
